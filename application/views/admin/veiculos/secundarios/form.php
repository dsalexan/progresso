                ...
                <div class="eight wide column">
                    ...
                    <?php
                        foreach($objeto['campos'] as $campo){
                            if(!array_key_exists('group', $campo)) $campo['group'] = false;
                    ?>
                            <div class="field">
                        ...
                        <?php if($campo['tipo'] == 'text'): ?>
                            ...
                            <div class="ui labeled input">
                                ...
                                <input tabindex=0 autofocus 
                                    <?php if($campo['id']!==false) echo 'id="'.$campo['id'].'"'; ?>
                                    type="text" name="<?=$campo['nome']?>" placeholder="<?=$campo['placeholder']?>">
                            </div>

                        <?php endif;
                        if($campo['tipo'] == 'dropdown'): ?>

                            <div dropdown-id="veiculo-<?=$campo['nome']?>" <?php if($campo['group']!==false) echo 'data-group="'.$campo['group'].'"'; ?> class="ui fluid dropdown labeled search icon button">
                                ...
                                <div class="menu">
                                    <div class="ui buttons grid fluid top attached">
                                        <div class="ui sixteen wide column button clear-secondary" clear dropdown-id="veiculo-<?=$campo['nome']?>">
